...
@section('content')
<!-- <h1 class="mt-5 mb-4">Mettre à jour les informations de l'étudiant</h1> -->
<div class="row justify-content-center mt-5 mb-5">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Mettre à jour les informations de l'étudiant</h5>
            </div>
            <div class="card-body">
                <form method="post">
                    @method('put')
                    ...
                    <div class="mb-3">
                        ...
                        <select name="ville_id" id="ville_id" class="form-select" aria-label="Default select example">
                            ...
                            <option value="{{ $ville->id }}" @if($ville->id == old('ville_id', $etudiant->ville_id)) selected @endif>
                                {{ $ville->nom }}
                            </option>
                            @endforeach
                        </select>
